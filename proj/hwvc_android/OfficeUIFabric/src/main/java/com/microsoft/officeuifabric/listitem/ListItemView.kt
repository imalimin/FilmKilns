...
open class ListItemView : TemplateView {
    ...
    internal val textAreaEndInset: Float
        get() = resources.getDimension(R.dimen.uifabric_list_item_horizontal_margin_regular)
    ...
    private fun updateCustomAccessoryViewPadding() {
        ...
        customAccessoryView.setPaddingRelative(
            customAccessoryView.paddingStart + resources.getDimension(R.dimen.uifabric_list_item_horizontal_spacing_custom_accessory_view_start).toInt(),
            customAccessoryView.paddingTop + verticalPadding,
            customAccessoryView.paddingEnd + resources.getDimension(R.dimen.uifabric_list_item_horizontal_margin_regular).toInt(),
    ...
    private fun updateTextViewContainerLayout() {
        ...
        val threeLineVerticalMargin = resources.getDimension(R.dimen.uifabric_list_item_vertical_margin_text_three_line).toInt()
        val horizontalMargin = resources.getDimension(R.dimen.uifabric_list_item_horizontal_margin_regular).toInt()
