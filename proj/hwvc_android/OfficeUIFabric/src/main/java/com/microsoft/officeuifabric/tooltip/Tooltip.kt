...
class Tooltip {
    ...
    private fun measureContentSize() {
        val widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(
            context.resources.getDimensionPixelSize(R.dimen.uifabric_tooltip_max_width),
    ...
    private fun initTooltipArrow(anchorRect: Rect, isRTL: Boolean, offsetX: Int) {
        ...
        val tooltipArrowWidth = context.resources.getDimensionPixelSize(R.dimen.uifabric_tooltip_arrow_height)
