...
/**
 *[ThemeUtil] came from client-android. Fabric currently uses this to generate background colors for
 * initials based on an array of colors defined in the app's theme.
 * //TODO: Trim this code down to what Fabric will actually need to use.
 */
object ThemeUtil {
