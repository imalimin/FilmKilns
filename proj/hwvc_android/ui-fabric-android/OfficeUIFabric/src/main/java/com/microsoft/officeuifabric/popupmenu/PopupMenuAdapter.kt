...
internal class PopupMenuAdapter : BaseAdapter {
    ...
    fun calculateWidth(): Int {
        var maxWidth = 0
        var minWidth = context.resources.getDimension(R.dimen.uifabric_popup_menu_item_min_width_no_icon).toInt()
        val minWidthWithIcon = context.resources.getDimension(R.dimen.uifabric_popup_menu_item_min_width_icon).toInt()
