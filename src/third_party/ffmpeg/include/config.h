...
#define FFMPEG_CONFIGURATION "--prefix=/Users/lmy/Projects/ffmpeg_builder/ffmpeg/product/arm64-v8a --target-os=android --sysroot=/Users/lmy/Library/Android/android-ndk-r14b/my/android-21/arm64/sysroot --enable-cross-compile --cross-prefix=/Users/lmy/Library/Android/android-ndk-r14b/my/android-21/arm64/bin/aarch64-linux-android- --cc=/Users/lmy/Library/Android/android-ndk-r14b/my/android-21/arm64/bin/aarch64-linux-android-gcc --nm=/Users/lmy/Library/Android/android-ndk-r14b/my/android-21/arm64/bin/aarch64-linux-android-nm --disable-shared --enable-static --disable-doc --enable-gpl --enable-nonfree --enable-logging --enable-jni --enable-mediacodec --enable-hwaccel=h264_mediacodec --enable-runtime-cpudetect --enable-zlib --enable-fft --enable-rdft --enable-swscale --enable-avresample --disable-gray --disable-ffplay --disable-ffprobe --disable-avdevice --disable-postproc --enable-network --disable-programs --disable-indevs --disable-outdevs --disable-symver --disable-w32threads --disable-debug --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-ffmpeg --disable-encoders --enable-libx264 --enable-encoder=libx264 --enable-encoder=aac --enable-encoder='pcm*' --enable-encoder=gif --enable-encoder=bmp --enable-encoder=mjpeg --disable-decoders --enable-decoder=h264_mediacodec --enable-decoder=h264 --enable-decoder=aac --enable-decoder='pcm*' --enable-decoder=gif --enable-decoder=amrnb --enable-decoder=amrwb --enable-decoder=bmp --enable-decoder=mjpeg --enable-librtmp --enable-protocol=librtmp --enable-protocol=file --enable-protocol=rtp --enable-protocol=tcp --enable-protocol=udp --disable-muxers --enable-muxer=h264 --enable-muxer=mp4 --enable-muxer=mov --enable-muxer=mp3 --enable-muxer=wav --enable-muxer=hevc --enable-muxer='pcm*' --enable-muxer=rawvideo --enable-muxer=gif --enable-muxer=f4v --enable-muxer=m4v --enable-muxer=flv --enable-muxer=image2 --enable-muxer=rtp --enable-muxer=rtsp --enable-muxer=rtmp --disable-demuxers --enable-demuxer=h264 --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=wav --enable-demuxer=hevc --enable-demuxer=aac --enable-demuxer='pcm*' --enable-demuxer=rawvideo --enable-demuxer=mpegvideo --enable-demuxer=gif --enable-demuxer=m4v --enable-demuxer=flv --enable-demuxer=image2 --enable-demuxer=rtp --enable-demuxer=rtsp --enable-demuxer=rtmp --disable-parsers --enable-parser=h264 --enable-parser=mpegaudio --enable-parser=mpegvideo --enable-parser=mpeg4video --enable-parser=hevc --enable-parser=aac --enable-parser=aac_latm --enable-parser=gif --enable-parser=bmp --enable-bsfs --disable-bsf=text2movsub --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=imx_dump_header --disable-bsf=chomp --disable-bsf=noise --disable-bsf=dump_extradata --disable-bsf=remove_extradata --disable-bsf=dca_core --disable-filters --enable-filter=amix --enable-filter=aformat --enable-filter=scale --enable-filter=format --enable-filter=aformat --enable-filter=fps --enable-filter=trim --enable-filter=atrim --enable-filter=vflip --enable-filter=hflip --enable-filter=transpose --enable-filter=rotate --enable-filter=yadif --enable-filter=pan --enable-filter=volume --enable-filter=aresample --enable-filter=atempo --enable-filter=asetrate --enable-filter=setpts --enable-filter=overlay --enable-filter=paletteuse --enable-filter=areverse --enable-filter=anull --enable-filter=palettegen --enable-filter=showwavespic --enable-filter=null --disable-devices --enable-pic --enable-asm --enable-yasm --enable-inline-asm --enable-optimizations --enable-small --extra-cflags=' -O3 -I/Users/lmy/Projects/ffmpeg_builder/x264/product/arm64-v8a/include -I/Users/lmy/Projects/ffmpeg_builder/librtmp -I/Users/lmy/Projects/ffmpeg_builder/librtmp/../' --extra-ldflags=' -L/Users/lmy/Projects/ffmpeg_builder/x264/product/arm64-v8a/lib -L/Users/lmy/Projects/ffmpeg_builder/librtmp/product/arm64-v8a/lib -lrtmp' --arch=aarch64 --enable-yasm"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/Users/lmy/Projects/ffmpeg_builder/ffmpeg/product/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/lmy/Projects/ffmpeg_builder/ffmpeg/product/arm64-v8a/share/ffmpeg"
