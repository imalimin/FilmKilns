...
#define FFMPEG_CONFIGURATION "--prefix=/Users/lmy/Projects/ffmpeg/ffmpeg/product/armeabi-v7a --target-os=android --sysroot=/Users/lmy/Library/Android/android-ndk-r14b/my/android-21/arm/sysroot --enable-cross-compile --cross-prefix=/Users/lmy/Library/Android/android-ndk-r14b/my/android-21/arm/bin/arm-linux-androideabi- --cc=/Users/lmy/Library/Android/android-ndk-r14b/my/android-21/arm/bin/arm-linux-androideabi-gcc --nm=/Users/lmy/Library/Android/android-ndk-r14b/my/android-21/arm/bin/arm-linux-androideabi-nm --disable-shared --enable-static --disable-doc --enable-gpl --enable-nonfree --enable-logging --enable-jni --enable-mediacodec --enable-hwaccel=h264_mediacodec --enable-runtime-cpudetect --enable-zlib --enable-fft --enable-rdft --enable-swscale --enable-avresample --disable-gray --disable-ffplay --disable-ffprobe --disable-avdevice --disable-postproc --disable-network --disable-programs --disable-indevs --disable-outdevs --disable-symver --disable-w32threads --disable-debug --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-ffmpeg --disable-encoders --enable-libx264 --enable-encoder=libx264 --enable-encoder=aac --enable-encoder=pcm_s8 --enable-encoder=pcm_s16le --enable-encoder=pcm_s16be --enable-encoder=pcm_s32le --enable-encoder=pcm_s32be --enable-encoder=pcm_f32be --enable-encoder=pcm_f32le --enable-encoder=gif --disable-decoders --enable-decoder=h264_mediacodec --enable-decoder=h264 --enable-decoder=aac --enable-decoder=pcm_s8 --enable-decoder=pcm_s16le --enable-decoder=pcm_s16be --enable-decoder=pcm_s32le --enable-decoder=pcm_s32be --enable-decoder=pcm_f32be --enable-decoder=pcm_f32le --enable-decoder=gif --enable-decoder=amrnb --enable-decoder=amrwb --enable-protocol=file --disable-muxers --enable-muxer=h264 --enable-muxer=mp4 --enable-muxer=mov --enable-muxer=mp3 --enable-muxer=wav --enable-muxer=hevc --enable-muxer=pcm_s8 --enable-muxer=pcm_s16le --enable-muxer=pcm_s16be --enable-muxer=pcm_s32le --enable-muxer=pcm_s32be --enable-muxer=pcm_f32be --enable-muxer=pcm_f32le --enable-muxer=rawvideo --enable-muxer=gif --enable-muxer=f4v --enable-muxer=m4v --enable-muxer=flv --disable-demuxers --enable-demuxer=h264 --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=wav --enable-demuxer=hevc --enable-demuxer=aac --enable-demuxer=pcm_s8 --enable-demuxer=pcm_s16le --enable-demuxer=pcm_s16be --enable-demuxer=pcm_s32le --enable-demuxer=pcm_s32be --enable-demuxer=pcm_f32be --enable-demuxer=pcm_f32le --enable-demuxer=rawvideo --enable-demuxer=mpegvideo --enable-demuxer=gif --enable-demuxer=m4v --enable-demuxer=flv --disable-parsers --enable-parser=h264 --enable-parser=mpegaudio --enable-parser=mpegvideo --enable-parser=mpeg4video --enable-parser=hevc --enable-parser=aac --enable-parser=aac_latm --enable-parser=gif --enable-bsfs --disable-bsf=text2movsub --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=imx_dump_header --disable-bsf=chomp --disable-bsf=noise --disable-bsf=dump_extradata --disable-bsf=remove_extradata --disable-bsf=dca_core --disable-filters --enable-filter=amix --enable-filter=aformat --enable-filter=scale --enable-filter=format --enable-filter=aformat --enable-filter=fps --enable-filter=trim --enable-filter=atrim --enable-filter=vflip --enable-filter=hflip --enable-filter=transpose --enable-filter=rotate --enable-filter=yadif --enable-filter=pan --enable-filter=volume --enable-filter=aresample --enable-filter=atempo --enable-filter=asetrate --enable-filter=setpts --enable-filter=overlay --enable-filter=paletteuse --enable-filter=areverse --enable-filter=anull --enable-filter=palettegen --enable-filter=null --disable-devices --enable-pic --enable-asm --enable-yasm --enable-inline-asm --enable-optimizations --enable-small --extra-cflags=' -O3 -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb -std=c99 -ffast-math -I/Users/lmy/Projects/ffmpeg/x264/product/armeabi-v7a/include' --extra-ldflags=' -Wl,--fix-cortex-a8 -pie -fPIC -L/Users/lmy/Projects/ffmpeg/x264/product/armeabi-v7a/lib' --arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --enable-asm"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/Users/lmy/Projects/ffmpeg/ffmpeg/product/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/lmy/Projects/ffmpeg/ffmpeg/product/armeabi-v7a/share/ffmpeg"
