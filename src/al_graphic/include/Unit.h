...
static constexpr int MSG_LAYER_UPDATE_RGBA = KID('A', 'I', 'G', 0x21);
static constexpr int MSG_LAYER_UPDATE_CLEAR = KID('A', 'I', 'G', 0x22);
static constexpr int MSG_LAYER_QUERY_ID_FUTURE = KID('A', 'I', 'G', 0x23);
...
static constexpr int MSG_SEQUENCE_TRACK_SET_DURATION = KID('A', 'S', 'Q', 0x07);
static constexpr int MSG_SEQUENCE_TRACK_UPDATE_NOTIFY = KID('A', 'S', 'Q', 0x08);
